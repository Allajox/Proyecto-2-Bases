...
public class PetColor extends DBItem {
    ...
    public static ResultSet getAll() {
        try {
            ...
            CallableStatement stmt = con.prepareCall("{ CALL getColor() }");
    ...
    public static void insert(String name) {
        try {
            Connection con = DriverManager.getConnection(host, uName, uPass);
            CallableStatement stmt = con.prepareCall("{ CALL insertColor(?) }");
    ...
    public void updateItem(int idColor, String name) {
        try {
            Connection con = DriverManager.getConnection(host, uName, uPass);
            CallableStatement stmt = con.prepareCall("{ CALL updateColor(?, ?) }");
    ...
    public void deleteItem(int selectedId) {
        try {
            Connection con = DriverManager.getConnection(host, uName, uPass);
            CallableStatement stmt = con.prepareCall("{ CALL deleteColor(?) }");
