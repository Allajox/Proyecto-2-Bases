...
ALTER TABLE `user`
    ...
    ADD CONSTRAINT user_idUser_nn CHECK (id_user IS NOT NULL);
...
ALTER TABLE `user`
    MODIFY COLUMN id_user INT COMMENT 'Primary key, identifier for the user',
...
ALTER TABLE association
    MODIFY id_user INT NOT NULL,
    ADD CONSTRAINT association_idUser_nn CHECK (id_user IS NOT NULL);
...
ALTER TABLE association
    MODIFY COLUMN id_user INT COMMENT 'Foreign key, references the user id',
...
ALTER TABLE adopter
    MODIFY id_user INT NOT NULL,
    ADD CONSTRAINT adopter_idUser_nn CHECK (id_user IS NOT NULL);
...
ALTER TABLE rescuer
    MODIFY id_user INT NOT NULL,
    ADD CONSTRAINT rescuer_idUser_nn CHECK (id_user IS NOT NULL);
...
ALTER TABLE rescuer
    MODIFY COLUMN id_user INT COMMENT 'Foreign key referencing the user id',
...
(
    id_user            INT,
    `name`             VARCHAR(100),
    requires_donations INT DEFAULT 0,
    createdBy          VARCHAR(20),
    createdAt          DATE,
    modifiedBy         VARCHAR(20),
    modifiedAt         DATE
...
ALTER TABLE crib_house
    MODIFY id_user INT NOT NULL,
    ADD CONSTRAINT cribHouse_idUser_nn CHECK (id_user IS NOT NULL);
...
ALTER TABLE log
    MODIFY id_log INT NOT NULL,
    ADD CONSTRAINT log_idLog_nn CHECK (id_log IS NOT NULL);
...
ALTER TABLE log
    MODIFY COLUMN id_log INT COMMENT 'Primary key, identifier for the log entry',
